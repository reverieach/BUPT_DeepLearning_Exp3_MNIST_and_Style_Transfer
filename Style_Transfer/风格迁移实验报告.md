...
|          总 Loss 曲线          |        内容与风格 Loss 分项         |
| :----------------------------: | :---------------------------------: |
| ![Total Loss](results/tb1.png) | ![Loss Components](results/tb2.png) |
...
| 训练进度 | 迭代次数 | 效果展示                                    |
| :------: | :------: | :------------------------------------------ |
| **10%**  |  1,000   | ![10%](results/training_progress_10%.png)   |
| **50%**  |  5,000   | ![50%](results/training_progress_50%.png)   |
| **80%**  |  8,000   | ![80%](results/training_progress_80%.png)   |
| **100%** |  10,000  | ![100%](results/training_progress_100%.png) |
...
| :---------------------------------: | :---------------------: | :-------------------------------------------------: |
| **图 1**<br>![Content 1](bupt1.jpg) | <br>![Style](style.jpg) | **结果 1**<br>![Result 1](results/result_bupt1.png) |
| **图 2**<br>![Content 2](bupt2.jpg) |         (同上)          | **结果 2**<br>![Result 2](results/result_bupt2.png) |
...
| :--------------------------------------------: | :--------------------------------------------: | :--------------------------------------------: |
| ![Alpha 0.3](results/alpha_test_alpha_0.3.png) | ![Alpha 0.6](results/alpha_test_alpha_0.6.png) | ![Alpha 0.9](results/alpha_test_alpha_0.9.png) |
